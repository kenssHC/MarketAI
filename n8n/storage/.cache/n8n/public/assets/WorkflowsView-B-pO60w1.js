import { d as defineComponent, a3 as useRoute, b as useRouter, aw as useFoldersStore, r as ref, x as computed, c as useI18n, aG as ProjectTypes, V as VIEWS, a9 as resolveComponent, h as createElementBlock, g as openBlock, i as createVNode, w as withCtx, k as unref, s as N8nCard, n as normalizeClass, j as createBaseVNode, f as createCommentVNode, e as createBlock, gR as ProjectCardBadge, aU as ResourceType, eV as N8nActionToggle, B as withModifiers, p as N8nText, l as createTextVNode, t as toDisplayString, fs as _sfc_main$a, m as N8nHeading, aL as N8nBadge, N as N8nIcon, _ as _export_sfc, a as useToast, Q as useUIStore, u as useUsersStore, a2 as useWorkflowsStore, av as useProjectsStore, aC as getResourcePermissions, gK as dateFormat, b4 as withDirectives, b5 as vShow, aa as N8nTooltip, aP as WORKFLOW_SHARE_MODAL_KEY, al as useTelemetry, aT as DUPLICATE_MODAL_KEY, am as useMessage, an as MODAL_CONFIRM, aV as PROJECT_MOVE_RESOURCE_MODAL, a8 as watch, d0 as onScopeDispose, gS as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, gT as ILLEGAL_FOLDER_CHARACTERS, gU as FOLDER_NAME_ONLY_DOTS_REGEX, gV as FOLDER_NAME_MAX_LENGTH, a0 as defineStore, dR as usePostHog, bK as useCloudPlanStore, bV as useTemplatesStore, bN as useStorage, gW as LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS, d_ as jsonParse, g9 as TEMPLATE_ONBOARDING_EXPERIMENT, a5 as STORES, z as N8nCallout, C as N8nLink, Y as renderSlot, ae as useNodeTypesStore, bW as usePersonalizedTemplatesV2Store, o as onMounted, cx as NodeIcon, c7 as EXPERIMENT_TEMPLATE_RECO_V2_KEY, F as Fragment, A as renderList, bR as usePersonalizedTemplatesV3Store, c4 as EXPERIMENT_TEMPLATE_RECO_V3_KEY, af as useSourceControlStore, bX as useCalloutHelpers, v as useSettingsStore, as as useTagsStore, fK as useUsageStore, gX as useInsightsStore, ay as useDocumentTitle, P as useDebounce, aH as useTemplateRef, aF as EnterpriseEditionFeature, gY as isExtraTemplateLinksExperimentEnabled, aq as createEventBus, X as onBeforeUnmount, ao as debounce, gZ as PROJECT_ROOT, cJ as createSlots, q as N8nButton, dv as InfoTip, eB as N8nActionBox, eK as N8nInputLabel, aK as _sfc_main$c, eN as N8nSelect, eO as _sfc_main$d, fI as N8nCheckbox, g_ as Draggable, eo as N8nLoading, aI as InlineRename, g$ as DEFAULT_WORKFLOW_PAGE_SIZE, c5 as trackTemplatesClick, c6 as TemplateClickSource, h0 as getEasyAiWorkflowJson, fN as COMMUNITY_PLUS_ENROLLMENT_MODAL } from "./index-MTM6BbvW.js";
import { _ as _sfc_main$b } from "./EmptySharedSectionActionBox.vue_vue_type_script_setup_true_lang-DWIEvR1-.js";
import { W as WorkflowActivator, F as FolderBreadcrumbs } from "./WorkflowActivator-DKpc2Acz.js";
import { B as Breadcrumbs } from "./ProjectBreadcrumb-HI65z9tX.js";
import { R as ResourcesListLayout } from "./ResourcesListLayout-CnidC9EV.js";
import { P as ProjectHeader } from "./ProjectHeader-BzekhnTR.js";
import { T as Tags } from "./Tags-D03vT_rK.js";
import { u as useProjectPages } from "./useProjectPages-JCNZbA2u.js";
...
import { u as useReadyToRunWorkflowsV2Store } from "./readyToRunWorkflowsV2.store-1dRkG6XV.js";
import { I as InsightsSummary } from "./InsightsSummary-XxOp2tas.js";
import "./PageViewLayout-B8D8Tkxn.js";
import "./TableBase-CX4nZLla.js";
...
const simplifiedLayout = "_simplifiedLayout_ny3db_123";
const header = "_header_ny3db_131";
const content = "_content_ny3db_138";
const welcome = "_welcome_ny3db_146";
const welcomeTitle = "_welcomeTitle_ny3db_150";
const welcomeDescription = "_welcomeDescription_ny3db_154";
const actionsContainer$1 = "_actionsContainer_ny3db_158";
const actionCard = "_actionCard_ny3db_165";
const cardIcon = "_cardIcon_ny3db_178";
const loading = "_loading_ny3db_181";
const cardContent = "_cardContent_ny3db_186";
const style0$1 = {
  simplifiedLayout,
  header,
  content,
