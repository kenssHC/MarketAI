const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RunDataJsonActions-Ct02vlvz.js","assets/index-MTM6BbvW.js","assets/index-CFiA0qjr.css","assets/_commonjs-dynamic-modules-TGKdzP3c.js","assets/RunDataJsonActions-B2jW3_UG.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, a_ as useNDVStore, dn as useTelemetryContext, r as ref, h2 as useElementSize, x as computed, i6 as executionDataToJson, h as createElementBlock, g as openBlock, e as createBlock, i as createVNode, w as withCtx, f as createCommentVNode, k as unref, e5 as defineAsyncComponent, e4 as Suspense, i7 as VueJsonPretty, i1 as TextWithHighlights, n as normalizeClass, i2 as MappingPill, g_ as Draggable, aW as __vitePreload, i3 as shorten, i5 as getMappedExpression, i8 as isString, i9 as nonExistingJsonPath, b_ as useExternalHooks, al as useTelemetry, _ as _export_sfc } from "./index-MTM6BbvW.js";
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const LazyRunDataJsonActions = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJsonActions-Ct02vlvz.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0)
    );
    const props = __props;
