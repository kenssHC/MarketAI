import { d as defineComponent, x as computed, c as useI18n, h as createElementBlock, g as openBlock, j as createBaseVNode, i as createVNode, n as normalizeClass, e as createBlock, f as createCommentVNode, cx as NodeIcon, k as unref, aI as InlineRename, C as N8nLink, w as withCtx, p as N8nText, l as createTextVNode, t as toDisplayString, N as N8nIcon, aa as N8nTooltip, ab as _sfc_main$3, _ as _export_sfc, r as ref, iN as LOCAL_STORAGE_NDV_PANEL_WIDTH, iO as toValue, h2 as useElementSize, a8 as watch, bD as toRef, d_ as jsonParse, a9 as resolveComponent, g_ as Draggable, a_ as useNDVStore, cm as useNodeHelpers, fa as storeToRefs, cj as usePinnedData, g4 as useWorkflowActivate, ae as useNodeTypesStore, Q as useUIStore, a2 as useWorkflowsStore, dm as useDeviceSupport, dn as useTelemetryContext, aH as useTemplateRef, iP as useNodeDocsUrl, io as getNodeOutputs, cc as NodeConnectionTypes, cq as START_NODE_TYPE, ip as EXECUTABLE_TRIGGER_NODE_TYPES, b2 as STICKY_NODE_TYPE, bY as useKeybindings, o as onMounted, ir as dataPinningEventBus, X as onBeforeUnmount, ap as normalizeStyle, cU as useStyles, iQ as getNodeIconSource, it as InputPanel, is as NodeSettings, aq as createEventBus, cT as N8nResizeWrapper, iu as APP_MODALS_ELEMENT_ID, bT as Teleport, al as useTelemetry, am as useMessage, an as MODAL_CONFIRM, b_ as useExternalHooks } from "./index-MTM6BbvW.js";
import { N as NDVFloatingNodes, T as TriggerPanel, O as OutputPanel } from "./TriggerPanel-BS69Ky8P.js";
import "./RunDataParsedAiContent-Bl49tvwG.js";
import "./core-HZaYo_tU.js";
import "./ConsumedTokensDetails.vue_vue_type_script_setup_true_lang-Bv40HGJu.js";
import "./NodeView-B9LYqx2z.js";
import "./global-link-actions-DdzlWwjw.js";
import "./useExecutionDebugging-yUnwhnYk.js";
import "./useBeforeUnload-DsbgbymL.js";
import "./readyToRunWorkflows.store-nzu6XNAP.js";
import "./InfoAccordion-BpibqNsS.js";
      ...
      return openBlock(), createElementBlock("header", {
        ...
        createBaseVNode("div", {
          ...
          _ctx.docsUrl ? (openBlock(), createBlock(unref(N8nLink), {
            ...
            _: 1
          }, 8, ["href"])) : hasCustomName.value ? (openBlock(), createBlock(unref(N8nText), {
            key: 2,
            size: "small",
            bold: ""
          }, {
      ...
      return openBlock(), createBlock(Draggable, {
        ...
        default: withCtx(({ isDragging }) => [
          createBaseVNode("button", {
            ...
            _ctx.canMoveLeft ? (openBlock(), createBlock(_component_FontAwesomeIcon, {
              key: 0,
            ...
            _ctx.canMoveRight ? (openBlock(), createBlock(_component_FontAwesomeIcon, {
              key: 1,
              class: normalizeClass(_ctx.$style.arrow),
              icon: "arrow-right"
            }, null, 8, ["class"])) : createCommentVNode("", true)
