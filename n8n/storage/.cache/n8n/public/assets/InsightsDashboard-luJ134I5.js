const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-BEXUk0T6.js","assets/index-MTM6BbvW.js","assets/index-CFiA0qjr.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-DnEUMCMt.js","assets/chartjs.utils-DpK-YRAM.js","assets/InsightsSummary-XxOp2tas.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-P3-xVlwI.js","assets/InsightsChartFailed-Di6uVDGI.js","assets/InsightsChartFailureRate-Bl5Av3Eu.js","assets/InsightsChartTimeSaved-Bcup49B9.js","assets/InsightsChartAverageRuntime-CwkkxEk1.js","assets/InsightsTableWorkflows-B4re5fkw.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, eY as useModel, gX as useInsightsStore, h5 as getTimeRangeLabels, r as ref, hM as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, k as unref, eO as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, eN as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, fM as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, av as useProjectsStore, hN as INSIGHT_TYPES, e5 as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, b3 as onBeforeMount, m as N8nHeading, n as normalizeClass, gn as ProjectSharing, em as _sfc_main$4, c0 as resolveDynamicComponent, aW as __vitePreload, al as useTelemetry, hO as TELEMETRY_TIME_RANGE } from "./index-MTM6BbvW.js";
...
const InsightsUpgradeModal = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1fe3ab9e"]]);
const _hoisted_1 = {
  class: "mt-s",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-BEXUk0T6.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-DnEUMCMt.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-Di6uVDGI.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-Bl5Av3Eu.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-Bcup49B9.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-CwkkxEk1.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-B4re5fkw.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
