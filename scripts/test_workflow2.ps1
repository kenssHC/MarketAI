# ============================================
# TEST: Workflow 2 - Ideas Generator
# ============================================

Write-Host "`n=====================================" -ForegroundColor Cyan
Write-Host "  TEST: Workflow 2 - Ideas" -ForegroundColor Cyan
...
# ============================================
# TEST: Generación de Ideas
# ============================================

Write-Host "[TEST] Generando ideas para contenido SEO..." -ForegroundColor Yellow
Write-Host ""
...
Write-Host "  Keywords: seo, marketing digital, contenido" -ForegroundColor Gray
Write-Host "  Tema: marketing digital" -ForegroundColor Gray
Write-Host "  Objetivo: generar trafico organico" -ForegroundColor Gray
Write-Host ""
...
try {
    ...
    if ($result.ideas) {
        Write-Host "  Ideas generadas: $($result.ideas.Count)" -ForegroundColor White
    } else {
    ...
    if ($_.Exception.Message -like "*404*") {
        ...
        Write-Host "  2. Busca 'SEO - 02 Clasificación de Ideas'" -ForegroundColor Gray
