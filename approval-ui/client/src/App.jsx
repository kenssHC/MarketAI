...
function BlogKeywords({ onOpenEditor, onToast, refreshKey, onPreviewCacheUpdate = () => { } }) {
      ...
      for (let index = 0; index < pending.length; index += 1) {
        ...
        try {
          ...
          updateProgress(
            ...
            stopRequested ? 'Deteniendo despues de completar el articulo actual...' : ''
          ...
          console.error('[keywords] Error al generar articulo', generationError);

          if (isConnectionError(generationError)) {

            setConnectionIssue({

              message: 'Perdimos la conexion con el servidor. Verifica tu red o VPN e intenta continuar.',
  ...
  const isConnectionError = (error) => {
    ...
    return (
      ...
      String(error?.code || '').includes('etimedout') ||

      String(error?.cause?.code || '').includes('und_err_connect_timeout')
    ...
    <div className="panel">
      ...
      {connectionIssue && (
        ...
        <div className="editor-overlay">
          ...
          <div className="editor-panel connection-panel">

            <header className="editor-header">

              <div>

                <h2>Conexion interrumpida</h2>

                <p className="muted">

                  {connectionIssue.message || 'No pudimos comunicarnos con el servidor.'}
            ...
            <div className="editor-body">
              ...
              {connectionIssue.details ? (
                ...
                <p className="muted small">{connectionIssue.details}</p>

              ) : (

                <p className="muted small">Revisa tu conexion y vuelve a intentar la generacion.</p>
            ...
            <footer className="editor-footer">
              ...
              <button className="btn btn-ghost" onClick={() => setConnectionIssue(null)}>
